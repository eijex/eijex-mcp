...
export const ALL_TOOLS: McpToolDefinition[] = [
  // ── Agents ────────────────────────────────────────────────────────────
  {
    ...
    longDescription:
      ...
      'Uses the FactorForge v3.2.5 stable design path: DP feasibility design, profile-based rule scanning, Type IIS site review, and output. ' +
    ...
    keyFeatures: [
      'Constraint-based DP feasibility design (v3.2.5)',
      'CAI and GC% metrics',
