...
export const ALL_TOOLS: McpToolDefinition[] = [
  // ── Agents ────────────────────────────────────────────────────────────
  {
    ...
    longDescription:
      ...
      'Uses the FactorForge v3.2.3 stable design path: DP feasibility design, profile-based rule scanning, Type IIS site review, and output. ' +
    ...
    keyFeatures: [
      'Constraint-based DP feasibility design (v3.2.3)',
      'CAI and GC% metrics',
