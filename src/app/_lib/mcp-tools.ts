...
export const ALL_TOOLS: McpToolDefinition[] = [
  // ── Agents ────────────────────────────────────────────────────────────
  {
    ...
    longDescription:
      ...
      'Uses the FactorForge v3.3.2 stable design path with the N. benthamiana NbeV1.1 high-confidence CDS-derived active default: DP feasibility design, profile-based rule scanning, Type IIS site review, and output. ' +
